...
@Service
public class KafkaConsumerUpcomingTaskServiceImpl implements com.todolist.notificationservice.service.KafkaConsumerUpcomingTaskService {
    ...
    @Override
    @KafkaListener(topics = "${task.notification.topic.upcomingTask}", groupId = "notification-group")
